    ...
    public void Configure(EntityTypeBuilder<TestQuestion> builder)
    {
        builder.ToTable("TestQuestion", table =>
        {
            ...
            table.HasCheckConstraint(
                "CK_TestQuestion_PtagAtSelection",
        ...
        builder.HasOne(x => x.SourceBlueprintDetail)
        ...
        builder.HasOne<TagTopicReadModel>()
            ...
            .OnDelete(DeleteBehavior.NoAction)
            .HasConstraintName("FK_TestQuestion_TagTopic_RecommendedForTagID");
        builder.HasOne<TagDifficultyReadModel>()
            .WithMany()
            .HasForeignKey(x => x.RecommendedDifficultyId)
            .OnDelete(DeleteBehavior.NoAction)
            .HasConstraintName("FK_TestQuestion_TagDifficulty_RecommendedDifficultyID");
