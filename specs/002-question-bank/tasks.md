...
- [x] Harden OCR draft semantics: observed answer marks only, forced null correctness, explicit-solution-only output, and warning for visual content without an extracted image candidate.
