              ...
              {formattedItems.length === 0 ? (
                ...
                formattedItems.map((item, idx) => (
                  <SelectPrimitive.Item
                    ...
                    className={cn(
                      "relative flex w-full cursor-pointer select-none items-center rounded-lg py-2 pl-3 pr-8 text-xs text-on-surface outline-none focus:bg-surface-container-low focus:text-primary data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-colors",
                      itemClassName
                    )}
                  >
