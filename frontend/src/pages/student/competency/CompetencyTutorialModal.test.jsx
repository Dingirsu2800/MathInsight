...
describe('CompetencyTutorialModal', () => {
  ...
  it('renders step 1 by default when isOpen is true', () => {
    ...
    expect(screen.getByText('Điểm Năng Lực Tổng Quát (Overall Competency Score)')).toBeInTheDocument();
  ...
  it('navigates through steps when clicking Next and Back', () => {
    ...
    expect(screen.getByText('Điểm Năng Lực Cho Mỗi Chủ Đề (Official Point)')).toBeInTheDocument();
